...
| [`novu-connect-agent`](./skills/connect-agent) | Create a Novu managed agent and connect a channel (Slack, email, Telegram, WhatsApp, MS Teams) via `npx novu connect --ci` |
