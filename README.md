...
| [`novu-agent-onboarding`](./skills/agent-onboarding) | Create a Novu managed agent and connect a channel (Slack, email, Telegram, WhatsApp, MS Teams) via `npx novu connect --ci` |
